...
The **mean** number of steps taken: `r mean.steps`  
The **median** number of steps taken: `r median.steps`  
...
The 5-minute interval that contains the maximum number of steps: `r max.interval`  
...
```
The total number of missing values is: `r num.na`  

In order to replace any `r NA` values in the steps variable, we will scan the column for `r NA` values, and then replace them with the mean value that corresponds to that time interval.
...
The **mean** total number of steps per day is: `r mean.steps.day`  
The **median** total number of steps per day is: `r median.steps.day`  
Q: Do these values differ from the estimates from the first part of the assignment?    
A: Yes!  
Q: What is the impact of imputing missing data on the estimates of the total daily number of steps?  
A: The impact is minimal, changing the median value from `r median.steps` to `r median.steps.day`  
